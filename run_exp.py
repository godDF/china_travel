# Patch SSL to avoid Windows certificate store corruption
import ssl as _ssl
...
if __name__ == "__main__":
    ...
    parser.add_argument('--search_width', '-sw', type=int, default=None, help='Limit candidate search width during DFS (smaller = faster, larger = more thorough). Recommended: 3-5.')
